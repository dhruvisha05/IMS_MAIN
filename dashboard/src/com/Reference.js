...
function AddReference() {
    ...
    const addreference = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3000/reference/reference', {
            ...
            <Container  fluid className="ps-0">
                ...
                <Col xl={2} lg={3} md={4}   className="bg-black height text-white text-opacity-50 border-top border-secondary">
                    ...
                    <Col className='d-flex justify-content-center '> 
                        ...
                        <div    >
                        <form method='post' className='my-5 '  onSubmit={addreference} >
                            <table border={1} className=' border-1  border-black p-3 rounded-2'>
                                <tr className='my-3 text-center'>
                                    <th colSpan={2} className='h1 py-3'>ADD REFERENCE</th>  
                                </tr>
                                <tr className='my-3'>
